...
namespace Core.Common.Extensions {
    public static class NameReaderExtensions {
        ...
        public static string Prop<T>(this T instance, Expression<Func<T, object>> expression) {
            return GetMemberName(expression.Body);
        }

        public static List<string> Props<T>(this T instance, params Expression<Func<T, object>>[] expressions) {
